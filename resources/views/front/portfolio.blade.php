                ...
                <div class="mixitup-gallery">
                    ...
                    <div class="filters clearfix">
                        ...
                        <ul class="filter-tabs filter-btns text-center clearfix">
                            ...
                            <li class="filter" data-role="button" data-filter=".brand">branding</li>
                            <li class="filter" data-role="button" data-filter=".web">web/app</li>
                            <li class="filter" data-role="button" data-filter=".motion">motions</li>
                            <li class="filter" data-role="button" data-filter=".photo">photography</li>
                        </ul>
                    ...
                    <div class="filter-list row clearfix">
                        ...
                        <!-- Project Block -->
                        <div class="project-block mix motion photo web col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/7.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                        ...
                        <!-- Project Block -->
                        <div class="project-block mix web photo col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/8.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                        ...
                        <!-- Project Block -->
                        <div class="project-block mix photo motion col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/9.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                        ...
                        <!-- Project Block -->
                        <div class="project-block mix brand col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/10.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                                            <h4><a href="project-detail.html">Choco tasty</a></h4>
                                        </div>
                                        <div class="pull-right">
                                            <div class="category">Photography, Motions</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Project Block -->
                        <div class="project-block mix web motion col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/11.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                                            <h4><a href="project-detail.html">Fody App</a></h4>
                                        </div>
                                        <div class="pull-right">
                                            <div class="category">Web/App, Motion</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="project-block mix brand col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/12.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                                            <h4><a href="project-detail.html">Herb Healthy Branding</a></h4>
                                        </div>
                                        <div class="pull-right">
                        ...
                        <div class="project-block mix photo motion col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/13.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                                            <h4><a href="project-detail.html">Minim Milk Bottle</a></h4>
                                        </div>
                                        <div class="pull-right">
                                            <div class="category">Branding</div>
                                        </div>
                        ...
                        <!-- Project Block -->
                        <div class="project-block mix web photo brand col-lg-6 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="project-detail.html"><img src="assets/images/gallery/14.jpg" alt="" /></a>
                                </div>
                                <div class="lower-box">
                                    <div class="clearfix">
                                        <div class="pull-left">
                                            <h4><a href="project-detail.html">Orblo Journal Redesign</a></h4>
                                        </div>
                                        <div class="pull-right">
                                            <div class="category">Branding</div>
                                        </div>
